...
class mainapp(App):
    ...
    def on_button_press(self,instance):
        ...
        if button_text=="C":
            ...
            if current and (
                self.last_was_operator and button_text in self.operators #if user enter the two operator simultaneously
            ):
                return
            elif current=="" and button_text in self.operators:#if user enters the operator first insted of operand
                return
            else:
